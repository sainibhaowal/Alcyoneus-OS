...
This directory contains examples demonstrating the use of the `@tool` decorator in the alcyoneus framework.
...
```python
from alcyoneus.utils import get_tool_metadata, has_tool_decorator
...
- [Core decorators module](../../alcyoneus/utils/decorators.py)
- [ToolNode documentation](../../alcyoneus/graph/tool_node/)
