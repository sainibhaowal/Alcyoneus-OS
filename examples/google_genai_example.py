"""
Example: Using Google Generative AI (google-genai) with Alcyoneus OS

This example demonstrates how to use the Google GenAI adapter with Alcyoneus OS.
...
from alcyoneus.runtime.adapters.llm import GoogleGenAIConverter
