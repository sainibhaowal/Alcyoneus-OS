...
from alcyoneus.prebuilt.agent.supervisor_team import SupervisorTeamAgent, WorkerConfig
    ...
    return SupervisorTeamAgent(
        ...
        workers={
            "RESEARCHER": WorkerConfig(
                ...
                description=("Searches the web for factual information on any topic."),
            ),
            "CODER": WorkerConfig(
                agent=Agent(
            ...
            "WRITER": WorkerConfig(
                ...
                description=("Writes polished technical reports from research and code outputs."),
            ),
        },
        max_rounds=10,
    )
