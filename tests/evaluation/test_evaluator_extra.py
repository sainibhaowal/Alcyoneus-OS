...
from alcyoneus.qa.evaluation.collectors.trajectory_collector import TrajectoryCollector
from alcyoneus.qa.evaluation.config.eval_config import EvalConfig
from alcyoneus.qa.evaluation.dataset.eval_set import EvalCase, EvalSet
from alcyoneus.qa.evaluation.eval_result import CriterionResult, EvalCaseResult
...
def test_run_reporters_handles_pipeline_exception():
    ...
    with patch("alcyoneus.qa.evaluation.reporters.manager.ReporterManager", side_effect=RuntimeError("x")):
...
async def test_runner_run_reporters_is_best_effort():
    ...
    with patch("alcyoneus.qa.evaluation.reporters.manager.ReporterManager") as mgr_cls:
        mgr = MagicMock()
