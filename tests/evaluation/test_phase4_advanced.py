...
class TestHallucinationCriterion:
    ...
    async def test_extract_context_from_tools(self):
        ...
        from alcyoneus.qa.evaluation import ToolCall
...
class TestUserSimulator:
    ...
    def test_init_with_config(self):
        ...
        from alcyoneus.qa.evaluation import UserSimulatorConfig
...
class TestTestingUtilities:
    ...
    def test_create_simple_eval_set(self):
        ...
        from alcyoneus.qa.evaluation.testing import create_simple_eval_set
    ...
    def test_assert_eval_passed_success(self):
        ...
        from alcyoneus.qa.evaluation.testing import assert_eval_passed
        from alcyoneus.qa.evaluation import EvalReport, EvalCaseResult, CriterionResult
    ...
    def test_assert_criterion_passed_success(self):
        ...
        from alcyoneus.qa.evaluation.testing import assert_criterion_passed
        from alcyoneus.qa.evaluation import EvalReport, EvalCaseResult, CriterionResult
    ...
    def test_assert_criterion_passed_not_found(self):
        ...
        from alcyoneus.qa.evaluation.testing import assert_criterion_passed
        from alcyoneus.qa.evaluation import EvalReport
