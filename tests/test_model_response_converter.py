...
class TestModelResponseConverter:
    ...
    @patch('alcyoneus.runtime.adapters.llm.openai_converter.OpenAIConverter')
    ...
    async def test_invoke_logs_warning_for_none_response(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="alcyoneus.adapters"):
    ...
    @patch('alcyoneus.runtime.adapters.llm.google_genai_converter.GoogleGenAIConverter')
