...
from alcyoneus.storage.store.embedding.openai_embedding import OpenAIEmbedding
...
class TestOpenAIEmbedding:
    ...
    def test_import_error_when_openai_not_available(self):
        ...
        with patch('alcyoneus.storage.store.embedding.openai_embedding.HAS_OPENAI', False):
    ...
    @patch('alcyoneus.storage.store.embedding.openai_embedding.HAS_OPENAI', True)
