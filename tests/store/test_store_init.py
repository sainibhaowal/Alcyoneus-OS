...
class TestStoreModuleImports:
    ...
    def test_embedding_classes_import(self):
        ...
        from alcyoneus.storage.store import BaseEmbedding
        
        assert BaseEmbedding is not None
        
        # Test optional OpenAIEmbedding import
        try:
            from alcyoneus.storage.store import OpenAIEmbedding
    ...
    def test_store_module_structure(self):
        ...
        import alcyoneus.storage.store as store_module
...
class TestOptionalDependencies:
    ...
    def test_graceful_degradation_without_openai(self):
        ...
        if 'alcyoneus.storage.store' in sys.modules:
            del sys.modules['alcyoneus.storage.store']
        if 'alcyoneus.storage.store.embedding.openai_embedding' in sys.modules:
            del sys.modules['alcyoneus.storage.store.embedding.openai_embedding']
        
        # Should still be able to import basic store functionality
        from alcyoneus.storage.store import BaseStore, MemoryRecord
    ...
    def test_store_functionality_without_optional_deps(self):
        ...
        from alcyoneus.storage.store.store_schema import MemoryRecord, MemorySearchResult
        from alcyoneus.storage.store.embedding.base_embedding import BaseEmbedding
...
class TestStoreModuleConstants:
    ...
    def test_has_openai_flag(self):
        ...
        from alcyoneus.storage.store.embedding.openai_embedding import HAS_OPENAI
    ...
    def test_embedding_module_constants(self):
        ...
        from alcyoneus.storage.store.embedding import BaseEmbedding
    ...
    def test_store_schema_enums(self):
        ...
        from alcyoneus.storage.store.store_schema import MemoryType, DistanceMetric, RetrievalStrategy
...
class TestStoreModuleCompatibility:
    ...
    def test_python_version_compatibility(self):
        ...
        # Import should work
        import alcyoneus.storage.store
        assert alcyoneus.storage.store is not None
    ...
    def test_circular_imports(self):
        ...
        from alcyoneus.storage.store import BaseStore
        from alcyoneus.storage.store import BaseEmbedding
        from alcyoneus.storage.store import MemoryRecord, MemorySearchResult
        from alcyoneus.storage.store.base_store import BaseStore as BaseStoreFromModule
        from alcyoneus.storage.store.embedding.base_embedding import BaseEmbedding as BaseEmbeddingFromModule
...
class TestStoreModuleDocumentation:
    ...
    def test_class_docstrings(self):
        ...
        from alcyoneus.storage.store import BaseStore, BaseEmbedding, MemoryRecord
    ...
    def test_enum_docstrings(self):
        ...
        from alcyoneus.storage.store import MemoryType, DistanceMetric
        from alcyoneus.storage.store.store_schema import RetrievalStrategy
...
class TestStoreModuleEdgeCases:
    ...
    def test_import_order_independence(self):
        ...
        modules_to_clear = [
            'alcyoneus.storage.store',
            'alcyoneus.storage.store.base_store',
            'alcyoneus.storage.store.store_schema',
            'alcyoneus.storage.store.embedding',
            'alcyoneus.storage.store.embedding.base_embedding'
        ]
        ...
        from alcyoneus.storage.store.store_schema import MemoryRecord
        from alcyoneus.storage.store.base_store import BaseStore
        from alcyoneus.storage.store.embedding.base_embedding import BaseEmbedding
        ...
        from alcyoneus.storage.store import BaseStore as TopLevelBaseStore
