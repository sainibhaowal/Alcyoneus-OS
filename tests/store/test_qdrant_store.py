...
from alcyoneus.storage.store.store_schema import MemoryType
from alcyoneus.storage.store.qdrant_store import QdrantStore
...
class TestQdrantStore:
    ...
    async def test_store_initialization(self, mock_embedding_service):
        ...
        with patch("qdrant_client.AsyncQdrantClient") as mock_client:
            ...
            assert store.collection == "alcyoneus_memories"
    ...
    def test_distance_metric_conversion(self, qdrant_store):
        ...
        from alcyoneus.storage.store.store_schema import DistanceMetric
...
class TestConvenienceFunctions:
    ...
    def test_create_local_qdrant_store(self, mock_embedding_service):
        ...
        with patch("qdrant_client.AsyncQdrantClient"):
            from alcyoneus.storage.store.qdrant_store import create_local_qdrant_store
    ...
    def test_create_remote_qdrant_store(self, mock_embedding_service):
        ...
        with patch("qdrant_client.AsyncQdrantClient"):
            from alcyoneus.storage.store.qdrant_store import create_remote_qdrant_store
    ...
    def test_create_cloud_qdrant_store(self, mock_embedding_service):
        ...
        with patch("qdrant_client.AsyncQdrantClient"):
            from alcyoneus.storage.store.qdrant_store import create_cloud_qdrant_store
