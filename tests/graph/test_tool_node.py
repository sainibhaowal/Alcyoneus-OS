...
from alcyoneus.core.state import ToolResult
from alcyoneus.utils import CallbackManager
from alcyoneus.core.state.message import Message, ToolResultBlock
...
class TestToolNode:
    ...
    def test_tool_node_init_with_mcp_client_missing_deps(self):
        ...
        with patch("alcyoneus.core.graph.tool_node.base.deps.HAS_FASTMCP", False):
...
class TestToolNodeMCPUserInfo:
    ...
    async def test_mcp_execute_passes_user_info_when_enabled(self):
        ...
        with patch("alcyoneus.core.graph.tool_node.base.deps.HAS_FASTMCP", True):
            with patch("alcyoneus.core.graph.tool_node.base.deps.HAS_MCP", True):
                tool_node = ToolNode(
