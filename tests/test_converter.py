...
from alcyoneus.core.state import AgentState, Message, ToolResultBlock
from alcyoneus.utils.converter import _convert_dict, convert_messages
...
class TestConverterUtils:
    ...
    @patch('alcyoneus.utils.converter.logger')
