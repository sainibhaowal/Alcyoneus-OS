...
from alcyoneus.prebuilt.agent.plan_act_reflect import (
...
class TestPlanActReflectAgentInit:
    def test_basic_init(self):
        with patch("alcyoneus.prebuilt.agent.plan_act_reflect.Agent", FakeManagedAgent):
...
class TestPlanActReflectAgentCompile:
    ...
    def test_compile_forwards_media_store_and_shutdown_timeout(self):
        ...
        with patch(
            "alcyoneus.prebuilt.agent.plan_act_reflect.StateGraph.compile",
            autospec=True,
