...
from alcyoneus.prebuilt.agent.structured_output import (
...
class TestStructuredOutputAgentInit:
    def test_basic_init(self):
        with patch("alcyoneus.prebuilt.agent.structured_output.Agent", FakeManagedAgent):
...
class TestStructuredOutputAgentCompile:
    ...
    def test_compile_forwards_media_store_and_shutdown_timeout(self):
        ...
        with patch(
            "alcyoneus.prebuilt.agent.structured_output.StateGraph.compile",
            autospec=True,
