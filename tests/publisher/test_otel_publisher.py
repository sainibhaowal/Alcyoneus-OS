...
from alcyoneus.runtime.publisher.otel_publisher import (
    ObservabilityLevel,
    OtelPublisher,
    SpanRegistry,
...
def test_setup_tracing_attaches_publisher():
    ...
    with patch("alcyoneus.runtime.publisher.otel_publisher._guard", return_value=None):
...
def test_guard_raises_when_opentelemetry_missing(monkeypatch):
    from alcyoneus.runtime.publisher import otel_publisher as op
