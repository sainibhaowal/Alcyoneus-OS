...
Dependency: aio-pika
Not installed by default; install extra: `pip install alcyoneus[rabbitmq]`.
"""
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        Args:
            config: Configuration dictionary. Supported keys:
                ...
                - exchange: Exchange name (default: "alcyoneus.events").
                - routing_key: Routing key (default: "alcyoneus.events").
        ...
        self.exchange: str = self.config.get("exchange", "alcyoneus.events")
        self.routing_key: str = self.config.get("routing_key", "alcyoneus.events")
        ...
        async with self._connection_lock:
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    "'pip install alcyoneus[rabbitmq]' or 'pip install aio-pika'."
                ) from exc
