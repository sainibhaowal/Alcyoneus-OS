...
Dependency: aiokafka
Not installed by default; install extra: `pip install alcyoneus[kafka]`.
"""
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        Args:
            config: Configuration dictionary. Supported keys:
                ...
                - topic: Kafka topic to publish to (default: "alcyoneus.events").
                - client_id: Client ID for the producer.
        ...
        self.topic: str = self.config.get("topic", "alcyoneus.events")
        ...
        async with self._producer_lock:
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    "'pip install alcyoneus[kafka]' or 'pip install aiokafka'."
                ) from exc
