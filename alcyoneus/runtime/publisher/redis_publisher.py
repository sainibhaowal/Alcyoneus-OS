...
Not installed by default; install extra: `pip install alcyoneus[redis]`.
"""
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        Args:
            config: Configuration dictionary. Supported keys:
                ...
                - channel: Pub/Sub channel name (default: "alcyoneus.events").
                - stream: Stream name (default: "alcyoneus.events").
                - maxlen: Max length for streams.
        ...
        self.channel: str = self.config.get("channel", "alcyoneus.events")
        self.stream: str = self.config.get("stream", "alcyoneus.events")
        ...
        async with self._connection_lock:
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    "'pip install alcyoneus[redis]' or 'pip install redis'."
                ) from exc
