...
# ── alcyoneus.graph span attributes ─────────────────────────────────────────
GRAPH_THREAD_ID = "alcyoneus.graph.thread_id"
GRAPH_RUN_ID = "alcyoneus.graph.run_id"
GRAPH_USER_ID = "alcyoneus.graph.user_id"
GRAPH_TOTAL_STEPS = "alcyoneus.graph.total_steps"
GRAPH_MODEL = "alcyoneus.graph.model"

# ── alcyoneus.node span attributes ───────────────────────────────────────────
NODE_NAME = "alcyoneus.node.name"
NODE_STEP = "alcyoneus.node.step"

# ── alcyoneus.tool span attributes ───────────────────────────────────────────
TOOL_NAME = "alcyoneus.tool.name"
TOOL_TYPE = "alcyoneus.tool.type"  # "local" | "mcp"

# ── lifecycle annotation (added as span event attribute) ─────────────────────
LIFECYCLE = "alcyoneus.lifecycle"

# ── provider name mapping (alcyoneus provider → OTEL gen_ai.system value) ────
