...
try:
    ...
    try:
        ...
        from a2a.server.tasks.task_updater import TaskState  # type: ignore[no-redef]
        from a2a.types import Part as TextPart  # type: ignore[no-redef]

        try:
            from a2a.types.a2a_pb2 import Task  # type: ignore[no-redef]
        except ImportError:
            Task = None  # type: ignore[assignment,misc]
    _A2A_IMPORT_ERROR: BaseException | None = None
