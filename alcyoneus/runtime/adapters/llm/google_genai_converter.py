"""
Converter for Google Generative AI SDK responses to alcyoneus Message format.
...
from alcyoneus.core.state.message import (
    Message,
    TokenUsages,
    generate_id,
)
...
logger = logging.getLogger("alcyoneus.adapters.google_genai")
...
class GoogleGenAIConverter(BaseConverter):
    """
    Converter for Google Generative AI responses to alcyoneus Message format.
