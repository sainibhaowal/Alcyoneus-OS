...
every other Alcyoneus OS converter.
...
logger = logging.getLogger("alcyoneus.adapters.openai_responses")
...
class OpenAIResponsesConverter(BaseConverter):
    """Convert OpenAI **Responses API** objects to Alcyoneus OS ``Message``.
