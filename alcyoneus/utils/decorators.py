...
alcyoneus framework. The decorators allow developers to attach metadata such as
...
def tool[F: Callable[..., Any]](
    ...
    *,
    ...
    within the alcyoneus framework. The metadata includes the tool's name, description,
