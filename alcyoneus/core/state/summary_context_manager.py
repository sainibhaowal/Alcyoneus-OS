...
from alcyoneus.core.llm.client_factory import detect_provider
...
from alcyoneus.core.state.reducers import remove_tool_messages


S = TypeVar("S", bound=AgentState)

logger = logging.getLogger("alcyoneus.state.summary")
...
class SummaryContextManager(BaseContextManager[S]):
    ...
    * ``token_budget``: estimated token count of the context
    ...
    Example::
        ...
        from alcyoneus.core.state import SummaryContextManager
