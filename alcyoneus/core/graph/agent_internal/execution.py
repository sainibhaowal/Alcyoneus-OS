...
class AgentExecutionMixin:
    ...
    async def execute(
        ...
        # Resolve internal media refs (alcyoneus://media/...) before provider call.
        ...
        from alcyoneus.runtime.publisher.events import (
            ContentType,
            Event,
            EventModel,
            EventType,
    ...
    async def _resolve_media_in_messages(  # noqa: PLR0915, PLR0912
        ...
        For messages that contain ``alcyoneus://media/`` URLs in their
        ...
        for msg in messages:
            ...
            for i, part in enumerate(content):
                ...
                if part_type == "image_url":
                    ...
                    if url.startswith("alcyoneus://media/"):
                        ref_media = type(
                            "MediaRef",
                            (),
                            {
                    ...
                    if url and url.startswith("alcyoneus://media/"):
                        ref_media = type(
                            "MediaRef",
                            (),
                            {
