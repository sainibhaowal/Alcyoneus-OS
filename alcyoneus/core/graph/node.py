...
from alcyoneus.core.graph.utils.stream_node_handler import StreamNodeHandler
...
from .node_execution_policy import NodeExecutionPolicy
...
class Node:
    ...
    def __init__(
        ...
        # Per-node execution policies (retry, cache, error handling, timeout).
        self.execution_policy = NodeExecutionPolicy(
