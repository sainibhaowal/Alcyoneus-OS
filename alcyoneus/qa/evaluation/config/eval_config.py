...
#   from alcyoneus.qa.evaluation.config.eval_config import XYZ
# continue to work without modification.
from alcyoneus.qa.evaluation.config.criterion_config import CriterionConfig, Rubric
from alcyoneus.qa.evaluation.config.reporter_config import ReporterConfig, UserSimulatorConfig
from alcyoneus.qa.evaluation.config.types import DEFAULT_JUDGE_MODEL, MatchType
