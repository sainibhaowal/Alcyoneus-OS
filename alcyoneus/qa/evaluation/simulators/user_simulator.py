...
from alcyoneus.core.llm.caller import call_llm
...
class UserSimulator:
    ...
    def _extract_response(self, result: dict[str, Any]) -> str:
        ...
        Handles alcyoneus Message objects (content = list[ContentBlock])
        ...
        for msg in reversed(messages):
            # alcyoneus Message object: role attr + content is list[ContentBlock]
