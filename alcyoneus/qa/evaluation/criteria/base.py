...
if TYPE_CHECKING:
    from alcyoneus.qa.evaluation.config.eval_config import CriterionConfig
...
class BaseCriterion(ABC):
    ...
    def __init__(self, config: CriterionConfig | None = None):
        ...
        """
        from alcyoneus.qa.evaluation.config.eval_config import CriterionConfig as _CriterionConfig
