"""QuickEval - Simplified evaluation interface for Alcyoneus OS agents.
...
from alcyoneus.qa.evaluation.evaluator import AgentEvaluator
from alcyoneus.qa.evaluation.reporters.console import print_report
