...
from alcyoneus.qa.evaluation.config.eval_config import CriterionConfig, EvalConfig
from alcyoneus.qa.evaluation.criteria import CRITERIA_REGISTRY
from alcyoneus.qa.evaluation.criteria.base import BaseCriterion
from alcyoneus.qa.evaluation.dataset.eval_set import EvalCase, EvalSet
...
logger = logging.getLogger("alcyoneus.evaluation")
...
class AgentEvaluator:
    ...
    Example:
        ```python
        from alcyoneus.qa.evaluation import AgentEvaluator, EvalConfig
        from alcyoneus.qa.evaluation.collectors import TrajectoryCollector, make_trajectory_callback
