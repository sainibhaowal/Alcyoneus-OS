"""
Agent Evaluation Module for Alcyoneus OS.
...
Example:
    ```python
    from alcyoneus.qa.evaluation import AgentEvaluator, EvalConfig, CriterionConfig
...
from alcyoneus.qa.evaluation.collectors.event_collector import EventCollector
from alcyoneus.qa.evaluation.collectors.trajectory_collector import (
    PublisherCallback,
    TrajectoryCollector,
...
# --- Config ---
from alcyoneus.qa.evaluation.config.eval_config import (
    CriteriaConfig,
    CriterionConfig,
    EvalConfig,
    MatchType,
...
# --- Criteria: base ---
from alcyoneus.qa.evaluation.criteria.base import (
    BaseCriterion,
    CompositeCriterion,
    SyncCriterion,
    WeightedCriterion,
)
from alcyoneus.qa.evaluation.criteria.factual_accuracy import FactualAccuracyCriterion

# --- Criteria: advanced ---
from alcyoneus.qa.evaluation.criteria.hallucination import HallucinationCriterion
from alcyoneus.qa.evaluation.criteria.llm_judge import LLMJudgeCriterion
from alcyoneus.qa.evaluation.criteria.llm_utils import LLMCallerMixin

# --- Criteria: response ---
from alcyoneus.qa.evaluation.criteria.response import (
    ContainsKeywordsCriterion,
    ExactMatchCriterion,
    ResponseMatchCriterion,
    RougeMatchCriterion,
)
from alcyoneus.qa.evaluation.criteria.rubric import RubricBasedCriterion
from alcyoneus.qa.evaluation.criteria.safety import SafetyCriterion

# --- Criteria: LLM-as-judge ---
from alcyoneus.qa.evaluation.criteria.simulation_goals import SimulationGoalsCriterion
...
from alcyoneus.qa.evaluation.dataset.eval_set import (
    EvalCase,
    EvalSet,
    Invocation,
    MessageContent,
...
# --- Results ---
from alcyoneus.qa.evaluation.eval_result import (
    CriterionResult,
    EvalCaseResult,
    EvalReport,
    EvalSummary,
...
# --- Evaluator ---
from alcyoneus.qa.evaluation.evaluator import AgentEvaluator, EvaluationRunner

# --- Execution ---
from alcyoneus.qa.evaluation.execution.result import ExecutionResult, NodeResponseData
from alcyoneus.qa.evaluation.quick_eval import QuickEval

# --- Reporters ---
from alcyoneus.qa.evaluation.reporters.base import BaseReporter
from alcyoneus.qa.evaluation.reporters.console import Colors, ConsoleReporter, print_report
...
from alcyoneus.qa.evaluation.reporters.manager import ReporterManager, ReporterOutput

# --- Simulators ---
from alcyoneus.qa.evaluation.simulators import (
    BatchSimulator,
