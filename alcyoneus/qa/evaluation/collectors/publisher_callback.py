...
from alcyoneus.utils.callbacks import AfterInvokeCallback, CallbackContext, InvocationType
...
class PublisherCallback(AfterInvokeCallback):
    ...
    async def _extract_node_message(self, output_data: Any) -> Any:
        ...
        """
        try:
            from alcyoneus.runtime.adapters.llm.model_response_converter import (
