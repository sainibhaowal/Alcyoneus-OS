"""Testing utilities for Alcyoneus OS.

This module provides utilities for testing Alcyoneus OS graphs and agents,
including:
...
Example:
    ```python
    from alcyoneus.qa.testing import TestAgent, TestContext, MockToolRegistry
